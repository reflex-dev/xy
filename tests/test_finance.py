...
import xy as fc
from xy.finance import FinanceChart, FinanceLayer, FinanceTools, Instrument, PositionDrawing
...
def test_equity_drawdown_materializes_stacked_performance_chart():
    ...
    np.testing.assert_allclose(fig.traces[0].base.values, 100.0)
...
def test_finance_chart_payload_carries_layers_and_tools():
    chart = fc.finance_chart(
        ...
        fc.y_axis(label="price", side="right", type_="linear"),
