...
export const ATTR_SLOTS = {
  ax: 0, ay: 1,
  // Finance marks use a separate program, so their six scalar channels can
  // safely reuse the base geometry slots.
  a_x: 0, a_open: 1, a_high: 2, a_low: 3, a_close: 4, a_dir: 5,
