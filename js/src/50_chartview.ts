...
export class ChartView {
  ...
  // addresses palette texels with the raw code). A dtype change re-ids the
  // buffer so any VAO holding the old pointer config rebuilds instead of
  // silently misreading the bytes.
