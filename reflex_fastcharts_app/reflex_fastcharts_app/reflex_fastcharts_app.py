...
chart = fc.chart(
    ...
    fc.x_band("Wed", "Fri", text="launch window", color="#2563eb", opacity=0.10),
    fc.hline("High", text="alert threshold", color="#e11d48", width=1.8),
    fc.text("Thu", "Critical", "max load", dx=8, dy=-12, color="#111827"),
