...
class PayloadMixin(_Host):
    ...
    def _density_trace_spec(self, t: Trace, xr, yr, w, h, pw: "_PayloadWriter") -> dict[str, Any]:  # noqa: ANN001
        ...
        # the wire for the client's count-only LUT fallback (hand-built specs,
        # legacy grids); the shipped paths never colormap counts anymore.
        cmap = (
            t.color_ch.colormap
        ...
        if bin_colors is not None:
            ...
            # light). Aggregated — recorded as such — never dropped.
