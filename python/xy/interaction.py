...
def density_view(
    ...
    # COLOR-channelled trace skips this fast path entirely — its upsampled
    # colored-pyramid grid stays (blurry but truthful) rather than flipping
    # to a count-only surface the shader would have to colormap.
