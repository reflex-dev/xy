...
| `psd`, `csd`, `cohere`, `specgram` | Native Hann-windowed Welch spectra use Matplotlib 3.11's default `detrend_none` semantics. Explicit detrending modes remain unsupported and fail loudly instead of silently changing the signal |
