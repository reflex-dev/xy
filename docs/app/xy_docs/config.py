...
DOCS_SECTIONS = (
    ...
    (
        ...
        (
            ...
            ("Area, Step & Stairs", "/charts/area-chart/"),
            ("Scatter", "/charts/scatter/"),
            ("Bar and Column", "/charts/bar-chart/"),
            ("Histogram", "/charts/histogram/"),
            ("Box Plot", "/charts/box-plot/"),
            ("Violin Plot", "/charts/violin-plot/"),
            ("ECDF", "/charts/ecdf/"),
            ("Heatmap", "/charts/heatmap/"),
            ("Hexbin", "/charts/hexbin/"),
            ("Contour", "/charts/contour-plot/"),
    ...
    (
        ...
        (
            ...
            ("Facets and Layers", "/components/facets-and-layers/"),
        ),
    ),
    (
        "Integrations",
