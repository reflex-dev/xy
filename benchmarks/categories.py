...
BENCHMARK_CATEGORIES: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "metrics": "payload prep, navigation readiness, per-chart creation, shader compiles/program links, startup long tasks, JS heap, redraw submission, scroll visibility, context loss/restore, stable chart-count ceiling",
