...
BENCHMARK_CATEGORIES: tuple[dict[str, str], ...] = (
    {
        ...
        "harness": "benchmarks/bench_vs.py --ttfr at 1k-100k",
        "status": "tracked",
    ...
    },
    {
        ...
        "harness": "benchmarks/bench_scatter_native.py, benchmarks/bench_vs.py, example app assets",
        "status": "tracked",
    ...
    },
    {
        ...
        "harness": "benchmarks/bench.py, benchmarks/bench_native.py",
        "status": "tracked",
    ...
    },
    {
        ...
        "harness": "benchmarks/bench_vs.py, benchmarks/bench_scatter_native.py, example app asset sizes",
        "status": "tracked",
