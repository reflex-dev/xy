...
def validate_ci_workflow(path: Path = DEFAULT_CI_WORKFLOW) -> list[str]:
    ...
    _require_job_contains(
        ...
        "pyplot_gallery_extended",
        "CI",
        "strict 13-example extended gallery environment",
        ...
        "Run all 13 extended differential examples",
        "Require 13/13 extended acceptance with no waivers",
    ...
    _require_step_contains(
        ...
        "pinned Matplotlib compatibility dependency",
