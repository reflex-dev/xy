    ...
    checks = [
        ...
        Check(
            ...
            (
                ...
                "tests/test_figure.py::test_html_to_png_uses_browser_sandbox_by_default",
                "tests/test_figure.py::test_html_to_png_never_silently_downgrades_after_sandbox_failure",
                "tests/test_figure.py::test_html_to_png_reports_explicit_unsandboxed_launch_failure",
                "tests/test_batch_export.py::test_browser_session_never_silently_downgrades",
                "tests/test_batch_export.py::test_browser_session_honors_explicit_unsandboxed_opt_in",
        ...
        Check(
            "visual_health_smoke",
            "gallery visual health/occupancy smoke in Chromium",
            (py, "scripts/visual_health_smoke.py", chromium_arg),
            requires_modules=("numpy",),
            requires_paths=chromium_paths,
            requires_chromium=True,
        ),
        Check(
            "visual_baseline",
            "reviewed semantic/perceptual visual baselines in pinned Chromium",
            (
                py,
